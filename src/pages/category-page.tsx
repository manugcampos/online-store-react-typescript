...
const CategoryPage = () => {
  ...
  if (isLoading) return <p className="text-center text-xl mt-10">Cargando productos...</p>;
  if (error) return <p className="text-center text-red-500 mt-10">Error al cargar productos</p>;
